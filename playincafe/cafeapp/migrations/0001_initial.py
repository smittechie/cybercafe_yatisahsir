...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='user_in_status', to=settings.AUTH_USER_MODEL)),
                ('user_system', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='user_system', to='cafeapp.system')),
            ],
        ),
        migrations.CreateModel(
            name='History',
            fields=[
                ...
                ('user_system_history', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='user_system_history', to='cafeapp.status')),
            ],
        ),
    ]
